...
const char descriptor_table_protodef_greet_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "quest\032\021.Greet.HelloReply\0225\n\tSayHellos\022\023."
  "Greet.HelloRequest\032\021.Greet.HelloReply0\001b"
  "\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_greet_2eproto = {
  &descriptor_table_greet_2eproto_initialized, descriptor_table_protodef_greet_2eproto, "greet.proto", 207,
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(_internal_mutable_name(), ptr, ctx, "Greet.HelloRequest.name");
          CHK_(ptr);
...
#define DO_(EXPRESSION) if (!PROTOBUF_PREDICT_TRUE(EXPRESSION)) goto failure
  ::PROTOBUF_NAMESPACE_ID::uint32 tag;
  // @@protoc_insertion_point(parse_start:Greet.HelloRequest)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:Greet.HelloRequest)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:Greet.HelloRequest)
  return false;
#undef DO_
}
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(_internal_mutable_message(), ptr, ctx, "Greet.HelloReply.message");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
#define DO_(EXPRESSION) if (!PROTOBUF_PREDICT_TRUE(EXPRESSION)) goto failure
  ::PROTOBUF_NAMESPACE_ID::uint32 tag;
  // @@protoc_insertion_point(parse_start:Greet.HelloReply)
  for (;;) {
    ::std::pair<::PROTOBUF_NAMESPACE_ID::uint32, bool> p = input->ReadTagWithCutoffNoLastTag(127u);
    tag = p.first;
    if (!p.second) goto handle_unusual;
    switch (::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        if (static_cast< ::PROTOBUF_NAMESPACE_ID::uint8>(tag) == (10 & 0xFF)) {
          DO_(::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::ReadString(
                input, this->_internal_mutable_message()));
          DO_(::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
...
success:
  // @@protoc_insertion_point(parse_success:Greet.HelloReply)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:Greet.HelloReply)
  return false;
#undef DO_
}
#endif  // GOOGLE_PROTOBUF_ENABLE_EXPERIMENTAL_PARSER
